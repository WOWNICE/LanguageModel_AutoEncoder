...
import models.BasicLSTM.configuration as configuration
from models.BasicLSTM.model import AutoEncoder

FLAGS = tf.flags.FLAGS

tf.flags.DEFINE_string("input_file_pattern", "data/tfrecord/val-tfrecord-?????-of-????",
                       "File pattern of sharded TFRecord input files.")
tf.flags.DEFINE_string("checkpoint_dir", "models/BasicLSTM/train_log",
                       "Directory containing model checkpoints.")
tf.flags.DEFINE_string("eval_dir", "models/BasicLSTM/eval_log", "Directory to write event logs.")

tf.flags.DEFINE_integer("eval_interval_secs", 0,
                        "Interval between evaluation runs.")
tf.flags.DEFINE_integer("num_eval_examples", 3000,
...
def run():
    ...
    with g.as_default():
        ...
        model = AutoEncoder(model_config, mode="eval")
        model.build()
